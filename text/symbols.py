...
SYMBOLS_TABLE = [pad] + c + v + ja_symbols + pu_symbols + list(arpa)
SYMBOLS_TABLE = sorted(set(SYMBOLS_TABLE))

SYMBOLS_TABLE+=["[","]"]##日文新增上升下降调型
SYMBOLS_TABLE+=sorted(list(ko_symbols))
SYMBOLS_TABLE+=sorted(list(yue_symbols))##新加的yue统一摆在后头#已查过开头加Y后没有重复，韩文显然不会重复


if __name__ == "__main__":
    print(len(SYMBOLS_TABLE))
